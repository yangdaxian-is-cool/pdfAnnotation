...
//    *  移动到当前元素位置
//    */
//   // document.querySelectorAll('.canvas-container')[4].scrollIntoView()
//   //   document.scrollingElement.scrollTop = document.scrollingElement.scrollTop + 236 - 60
//   var eleSelect = canvas.getObjects()[0]
//   console.log(eleSelect);
//   canvas.setActiveObject(eleSelect, "mouse:down")
//   canvas.renderAll()

//   // console.log(canvas.getActiveObject());
//   // console.log(eleSelect.enterEditing());
//   // console.log(eleSelect.onClick());
//   // inst.fabricObjects[inst.active_canvas].fire("selection:created", { target: eleSelect})
//   // var activeObject = inst.fabricObjects[inst.active_canvas].getActiveObject();
//   // console.log(activeObject);
//   // if (activeObject) {
//   //   inst.fabricObjects[inst.active_canvas].fire("selection:updated", { selected: [activeObject.getObjects()[0]]})
//   // }
// }
